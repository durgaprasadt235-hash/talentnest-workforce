...
export const Permission = {
  ...
  BATCH_WEEKLY_ATTENDANCE: "BATCH_WEEKLY_ATTENDANCE",
  ...
  GENERATE_STAFFING_INVOICE: "GENERATE_STAFFING_INVOICE",
...
export const ROLE_PERMISSIONS: Record<Role, readonly Permission[]> = {
  ...
  [Role.ORGANIZATION_OWNER]: allViewPermissions,
  [Role.CORPORATE_ADMIN]: [
    ...
    Permission.MANAGE_USERS,
    Permission.VIEW_WEEKLY_ATTENDANCE,
    Permission.BATCH_WEEKLY_ATTENDANCE,
