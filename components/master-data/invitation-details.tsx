    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-5">
        ...
        {invitation && <>
          ...
          {invitation.status === "PENDING" && <div className="flex flex-wrap gap-3"><SignUpButton mode="modal"><Button>Create account</Button></SignUpButton><SignInButton mode="modal"><Button variant="outline">Sign in</Button></SignInButton></div>}
          {invitation.status !== "PENDING" && <p className="text-sm text-muted-foreground">This invitation is no longer pending. Contact your TalentNest administrator if you need access.</p>}
        </>}
      </CardContent>
    </Card>
  </main>
